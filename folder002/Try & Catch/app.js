...
} catch(e) {        // O parâmetro "e" também pode ser declarado como err, error...
...
} finally {         // Irá executar independente do resultado

    console.log('Foda-se o try e catch, eu vou ser executado de todo jeito');
