/****** PROTOTYPE - COMO HERDAR OS MÉTODOS PROTOTYPES DE UM OBJETO PRO OUTRO ******/
...
function Promocao(fName, lName, age, work, salary) {
    Pessoa.call(this, fName, lName, age);
    // Perceba que temos que chamar o método .call(),
    // onde o primeiro parâmetro deve ser o this,
    // seguido dos parâmetros que vem de Pessoa
    this.work = work;
    this.salary = salary;
}
...
// A saudação para pessoa1 é diferente da saudacao para pessoa2,
// pois pessoa2 por mais que herde o prototype saudacao de pessoa1,
// é possível manipula-la para que tenha alguma alteração
